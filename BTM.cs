...
namespace BTM
{
    class BTM
    {
        ...
        private class AddToVehicleCollection<Vehicle> : IAction<Vehicle> where Vehicle : IVehicle
        {
        ...
        public IBTMCollection<IVehicle> Vehicles
        {
            get
            {
                ...
                ForEach(buses.First(), new AddToVehicleCollection<IBytebus>(vehicles));
                ForEach(trams.First(), new AddToVehicleCollection<ITram>(vehicles));
                return vehicles;
            }
        }
        public IBTMCollection<IDriver> Drivers { get => drivers; set => drivers = value; }

        public static BTM GetInstance()
        {
            return instance ?? (instance = new BTM());
        }
        ...
        public void SetBaseExample()
        {
            ...
            Stops = new Vector<IStop>() { s1b, s2b, s3b, s4b, s5b, s6b, s7b, s8b, s9b };
            Drivers = new Vector<IDriver>() { d1b, d2b, d3b };
            Buses = new Vector<IBytebus>() { b1b, b2b, b3b, b4b, b5b };
        ...
        public void SetTextExample()
        {
            ...
            Stops = new Vector<IStop>() { s1ta, s2ta, s3ta, s4ta, s5ta, s6ta, s7ta, s8ta, s9ta };
            Drivers = new Vector<IDriver>() { d1ta, d2ta, d3ta };
            Buses = new Vector<IBytebus>() { b1ta, b2ta, b3ta, b4ta, b5ta };
        ...
        public void SetHashmapExample()
        {
            ...
            Stops = new Vector<IStop>() { s1ha, s2ha, s3ha, s4ha, s5ha, s6ha, s7ha, s8ha, s9ha };
            Drivers = new Vector<IDriver>() { d1ha, d2ha, d3ha };
            Buses = new Vector<IBytebus>() { b1ha, b2ha, b3ha, b4ha, b5ha };
